...
int _glfwCreateWindowWayland(_GLFWwindow* m_window, const _GLFWwndconfig* wndconfig, const _GLFWctxconfig* ctxconfig, const _GLFWfbconfig* fbconfig);
void _glfwDestroyWindowWayland(_GLFWwindow* m_window);
void _glfwSetWindowTitleWayland(_GLFWwindow* m_window, const char* title);
void _glfwSetWindowIconWayland(_GLFWwindow* m_window, int count, const GLFWimage* images);
void _glfwGetWindowPosWayland(_GLFWwindow* m_window, int* xpos, int* ypos);
void _glfwSetWindowPosWayland(_GLFWwindow* m_window, int xpos, int ypos);
void _glfwGetWindowSizeWayland(_GLFWwindow* m_window, int* width, int* height);
void _glfwSetWindowSizeWayland(_GLFWwindow* m_window, int width, int height);
void _glfwSetWindowSizeLimitsWayland(_GLFWwindow* m_window, int minwidth, int minheight, int maxwidth, int maxheight);
void _glfwSetWindowAspectRatioWayland(_GLFWwindow* m_window, int numer, int denom);
void _glfwGetFramebufferSizeWayland(_GLFWwindow* m_window, int* width, int* height);
void _glfwGetWindowFrameSizeWayland(_GLFWwindow* m_window, int* left, int* top, int* right, int* bottom);
void _glfwGetWindowContentScaleWayland(_GLFWwindow* m_window, float* xscale, float* yscale);
void _glfwIconifyWindowWayland(_GLFWwindow* m_window);
void _glfwRestoreWindowWayland(_GLFWwindow* m_window);
void _glfwMaximizeWindowWayland(_GLFWwindow* m_window);
void _glfwShowWindowWayland(_GLFWwindow* m_window);
void _glfwHideWindowWayland(_GLFWwindow* m_window);
void _glfwRequestWindowAttentionWayland(_GLFWwindow* m_window);
void _glfwFocusWindowWayland(_GLFWwindow* m_window);
void _glfwSetWindowMonitorWayland(_GLFWwindow* m_window, _GLFWmonitor* monitor, int xpos, int ypos, int width, int height, int refreshRate);
int _glfwWindowFocusedWayland(_GLFWwindow* m_window);
int _glfwWindowIconifiedWayland(_GLFWwindow* m_window);
int _glfwWindowVisibleWayland(_GLFWwindow* m_window);
int _glfwWindowMaximizedWayland(_GLFWwindow* m_window);
int _glfwWindowHoveredWayland(_GLFWwindow* m_window);
int _glfwFramebufferTransparentWayland(_GLFWwindow* m_window);
void _glfwSetWindowResizableWayland(_GLFWwindow* m_window, GLFWbool enabled);
void _glfwSetWindowDecoratedWayland(_GLFWwindow* m_window, GLFWbool enabled);
void _glfwSetWindowFloatingWayland(_GLFWwindow* m_window, GLFWbool enabled);
float _glfwGetWindowOpacityWayland(_GLFWwindow* m_window);
void _glfwSetWindowOpacityWayland(_GLFWwindow* m_window, float opacity);
void _glfwSetWindowMousePassthroughWayland(_GLFWwindow* m_window, GLFWbool enabled);

void _glfwSetRawMouseMotionWayland(_GLFWwindow* m_window, GLFWbool enabled);
...
void _glfwGetCursorPosWayland(_GLFWwindow* m_window, double* xpos, double* ypos);
void _glfwSetCursorPosWayland(_GLFWwindow* m_window, double xpos, double ypos);
void _glfwSetCursorModeWayland(_GLFWwindow* m_window, int mode);
...
void _glfwSetCursorWayland(_GLFWwindow* m_window, _GLFWcursor* cursor);
...
EGLNativeWindowType _glfwGetEGLNativeWindowWayland(_GLFWwindow* m_window);

void _glfwGetRequiredInstanceExtensionsWayland(char** extensions);
int _glfwGetPhysicalDevicePresentationSupportWayland(VkInstance s_instance, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceWayland(VkInstance s_instance, _GLFWwindow* m_window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
...
GLFWbool _glfwInputTextWayland(_GLFWwindow* m_window, uint32_t scancode);
