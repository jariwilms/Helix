...
int _glfwCreateWindowNull(_GLFWwindow* m_window, const _GLFWwndconfig* wndconfig, const _GLFWctxconfig* ctxconfig, const _GLFWfbconfig* fbconfig);
...
void _glfwSetWindowMonitorNull(_GLFWwindow* m_window, _GLFWmonitor* monitor, int xpos, int ypos, int width, int height, int refreshRate);
...
void _glfwSetWindowSizeLimitsNull(_GLFWwindow* m_window, int minwidth, int minheight, int maxwidth, int maxheight);
...
void _glfwGetWindowFrameSizeNull(_GLFWwindow* m_window, int* left, int* top, int* right, int* bottom);
...
int _glfwGetPhysicalDevicePresentationSupportNull(VkInstance s_instance, VkPhysicalDevice device, uint32_t queuefamily);
VkResult _glfwCreateWindowSurfaceNull(VkInstance s_instance, _GLFWwindow* m_window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);
