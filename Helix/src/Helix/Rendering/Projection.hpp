...
namespace hlx
{
	...
	public:
		...
		{
			OrthographicSettings(float leftPlane = -1.0f, float rightPlane = 1.0f, float bottomPlane = -1.0f, float topPlane = 1.0f)
		...
		static glm::mat4 createOrthographic(float leftPlane, float rightPlane, float bottomPlane, float topPlane)
		{
